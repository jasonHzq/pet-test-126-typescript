...
export class PetResource extends APIResource {
   ...
   * ```
   */
  findByStatus(query: PetFindByStatusParams, options?: RequestOptions): APIPromise<PetFindByStatusResponse> {
   ...
   * ```
   */
  findByTags(query: PetFindByTagsParams, options?: RequestOptions): APIPromise<PetFindByTagsResponse> {
