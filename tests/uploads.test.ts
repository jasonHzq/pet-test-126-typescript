import fs from 'fs';
import type { ResponseLike } from 'pet-test-126/internal/to-file';
import { toFile } from 'pet-test-126/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('pet-test-126/core/uploads');
    await expect(
