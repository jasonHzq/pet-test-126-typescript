# Pet Test 126 TypeScript MCP Server
...
```sh
git clone git@github.com:jasonHzq/pet-test-126-typescript.git
cd pet-test-126-typescript
./scripts/bootstrap
./scripts/build
```
...
export PET_TEST_126_API_KEY="My API Key"
node ./packages/mcp-server/dist/index.js
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npx -y pet-test-126-mcp`
...
```json
{
  "mcpServers": {
    "pet_test_126_api": {
      "command": "node",
      "args": [
        "/path/to/local/pet-test-126-typescript/packages/mcp-server",
        "--client=claude",
        "--tools=all"
      ],
      "env": {
        "PET_TEST_126_API_KEY": "My API Key"
      }
    }
  }
}
...
import { server, endpoints, init } from "pet-test-126-mcp/server";

// import a specific tool
import createPet from "pet-test-126-mcp/tools/pet/create-pet";
